...
class ProductService {
    ...
    async findAll(): Promise<Product[]> {
        ...
        return [
            ...
            { id: '08', category: 'Froid', name: 'Jambon beurre', image: '/assets/thumbnails/jambon-beurre.png', quantity: 100, price: 4.60 },
            { id: '09', category: 'Froid', name: 'Jambon tartare', image: '/assets/thumbnails/jambon-tartare.png', quantity: 10, price: 2.20 },
            { id: '10', category: 'Froid', name: 'Rosette', image: '/assets/thumbnails/rosette.png', quantity: 60, price: 2.90 },
            { id: '11', category: 'Froid', name: 'Paté', image: '/assets/thumbnails/pate.png', quantity: 5, price: 2.70 },
